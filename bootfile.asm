...
; Embedded data
boot_msg	db	" Pong by Dorcas Lanyero and Jeremiah England ", 13, 10
...
main:
    ...
    mov es, ax
    mov ah, 2
    mov al, 6 ; size of your payload in bytes divided by sector size (512)
	...
	;This stuff that your talking about here is entirely different.
    int 0x13
